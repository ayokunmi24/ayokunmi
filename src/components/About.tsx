        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6">
            ...
            <div className="mt-6">
              <a 
                href="/about-me"
                className="border border-border px-4 py-2 rounded-[30px] text-foreground hover:bg-accent transition-smooth text-base font-medium inline-flex items-center gap-2"
              >
                Read More
          ...
          <div className="grid gap-6">
            {highlights.map((item, index) => (
                <Card 
                key={index} 
                className="p-6 shadow-card hover:shadow-elegant transition-smooth hover:scale-105 border-border/20 backdrop-blur-sm bg-card/50"
              >
